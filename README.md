...
3. Activer les notifications sur vos comptes Dofus (option en jeu > général > notification en arrière plan) [screen](https://github.com/Sluss47/DracoonDofusRetro/blob/main/activer-notification-ig.png)
4. Activer les notifications Windows (Paramètre > Système > Actions et notifications > "activer"
5. Désactiver "autoriser les notifications à émettre des sons" (ou le faire spécifiquement pour Dofus si vous voulez garder le son pour les autres applications) [screen](https://github.com/Sluss47/DracoonDofusRetro/blob/main/activer-notification-windows1.png)
